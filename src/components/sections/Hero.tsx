    ...
    >
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 text-center flex flex-col items-center gap-6">
        ...
        >
          ...
          <h1 className="font-bold text-[#191d23] leading-tight">
            <span style={{ fontSize: "clamp(2rem, 5vw, 3.25rem)" }}>
              ...
              <br />
              <span className="text-[#ed3c6a]"> Property Management</span>
            </span>
          </h1>
        </div>
        ...
        >
          ...
          >
            Manage your Airbnb properties with ease. Our AI-powered assistants
            handle everything from guest communication to housekeeping scheduling
        ...
        >
          <Button
            size="lg"
            className="gap-2"
            style={{ boxShadow: "0 4px 24px rgba(237,60,106,0.35)" }}
          >
            Schedule A Meeting
        ...
        >
          ...
          <p className="text-sm text-[#64748b]">
            <span className="font-bold text-[#191d23]">2,000+</span> property
            managers trust us
          </p>
        </div>
      </div>
